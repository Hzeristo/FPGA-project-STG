...
#
# Script generated by Vivado on Thu Jan 11 16:15:43 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : success_blk_mem.sh
...
#
# Usage        : success_blk_mem.sh
#                success_blk_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                success_blk_mem.sh [-reset_run]
#                success_blk_mem.sh [-reset_log]
#                success_blk_mem.sh [-help]
#
...
#                script (type 'success_blk_mem.sh -help' for more information).
#
...
# script info
echo -e "success_blk_mem.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./success_blk_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.success_blk_mem xil_defaultlib.glbl -o success_blk_mem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./success_blk_mem_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key success_blk_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc success_blk_mem_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./success_blk_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: success_blk_mem.sh [-help]\n\
Usage: success_blk_mem.sh [-step]\n\
Usage: success_blk_mem.sh [-lib_map_path]\n\
Usage: success_blk_mem.sh [-reset_run]\n\
Usage: success_blk_mem.sh [-reset_log]\n\
Usage: success_blk_mem.sh [-keep_index]\n\
Usage: success_blk_mem.sh [-noclean_files]\n\n\
