...
#
# Script generated by Vivado on Thu Jan 04 17:20:00 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : player_dist_mem.sh
...
#
# Usage        : player_dist_mem.sh
#                player_dist_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                player_dist_mem.sh [-reset_run]
#                player_dist_mem.sh [-reset_log]
#                player_dist_mem.sh [-help]
#
...
# script info
echo -e "player_dist_mem.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./player_dist_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot player_dist_mem xil_defaultlib.player_dist_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim player_dist_mem -key {Behavioral:sim_1:Functional:player_dist_mem} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb player_dist_mem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./player_dist_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: player_dist_mem.sh [-help]\n\
Usage: player_dist_mem.sh [-step]\n\
Usage: player_dist_mem.sh [-lib_map_path]\n\
Usage: player_dist_mem.sh [-reset_run]\n\
Usage: player_dist_mem.sh [-reset_log]\n\
Usage: player_dist_mem.sh [-keep_index]\n\
Usage: player_dist_mem.sh [-noclean_files]\n\n\
