...
module Mux4to1b1( D0,
   ...
   *******************************************************************************/
   ...
   assign s_logisimNet8       = D0;
   assign s_logisimNet9       = D1;

   /*******************************************************************************
   ** Here all output connections are defined                                    **
   *******************************************************************************/
   assign Y = s_logisimNet12;
   ...
   *******************************************************************************/
   ...
   // NOT Gate
   assign s_logisimNet7 = ~s_logisimBus13[1];

   // NOT Gate
   assign s_logisimNet5 = ~s_logisimBus13[0];
   ...
   *******************************************************************************/
   ...
   AND_GATE #(.BubblesMask(2'b00))
      GATES_2 (.input1(s_logisimBus13[0]),
               .input2(s_logisimNet7),
   ...
   AND_GATE #(.BubblesMask(2'b00))
      GATES_4 (.input1(s_logisimBus13[0]),
               .input2(s_logisimBus13[1]),
