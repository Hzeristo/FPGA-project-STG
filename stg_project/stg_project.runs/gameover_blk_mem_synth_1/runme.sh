...
HD_PWD='D:/CodesPractice/learning/DL/FPGA-project-STG/stg_project/stg_project.runs/gameover_blk_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gameover_blk_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gameover_blk_mem.tcl
