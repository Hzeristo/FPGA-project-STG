...
HD_PWD='D:/CodesPractice/learning/DL/FPGA-project-STG/stg_project/stg_project.runs/success_blk_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log success_blk_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source success_blk_mem.tcl
