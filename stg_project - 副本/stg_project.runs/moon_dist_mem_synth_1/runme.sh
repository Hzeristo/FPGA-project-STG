...
HD_PWD='D:/CodesPractice/learning/DL/FPGA-project-STG/stg_project/stg_project.runs/moon_dist_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log moon_dist_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source moon_dist_mem.tcl
